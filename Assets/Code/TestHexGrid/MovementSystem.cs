...
public class MovementSystem : MonoBehaviour
{
    ...
    {
        movementRange = GraphSearch.BFSGetRange(hexGrid, hexGrid.GetClosetHex(selectedUnit.transform.position), selectedUnit.MovementPoints,false);
    }
    ...
    {
        Debug.Log("Move unit " + selectedUnit.name);
